                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <a href="tambah-barang.php" class="btn btn-primary btn-sm mb-1"><i class="fas fa-plus-circle"> </i> Tambah</a>
                                            ...
                                            <?php foreach ($data_mahasiswa as $mahasiswa) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a href="hapus-mahasiswa.php?id_mahasiswa=<?= $mahasiswa['id_mahasiswa']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('yakin ingin menghapus data Mahasiswa?');"><i class="fas fa-trash-alt"></i> Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
