...
<div class="container mt-5">
    ...
    <?php if ($_SESSION['level'] == 1) : ?>
        <button type="button" href="#" class="btn btn-primary mb-1" data-bs-toggle="modal" data-bs-target="#modalTambah"><i class="fas fa-plus-circle"></i> Tambah</button>
    <?php endif; ?>
