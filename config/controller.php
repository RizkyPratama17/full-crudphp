...
function create_mahasiswa($post)
{
    ...
    // query tambah data
    $query = "INSERT INTO mahasiswa VALUES(null, '$nama', '$prodi', '$jk', '$tlp', '$alamat', '$email', '$foto' )";
...
function update_mahasiswa($post)
{
    ...
    // query ubah data
    $query = "UPDATE mahasiswa SET nama = '$nama', prodi = '$prodi', jk = '$jk', telepon = '$alamat', alamat = '$alamat', email = '$email', foto = '$foto' WHERE id_mahasiswa = $id_mahasiswa ";
